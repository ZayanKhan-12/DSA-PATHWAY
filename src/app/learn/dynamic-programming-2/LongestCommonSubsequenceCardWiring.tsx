...
export default function LongestCommonSubsequenceCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/dynamic-programming-2/longest-common-subsequence";
    ...
    const isCorrectCardText = (text: string) => {
      ...
      return (
        ...
        clean.includes("classic 2d dp") &&
        clean.includes("two strings") &&
    ...
    const findCard = () => {
      ...
      ).filter((node) => normalize(node.textContent || "") === "longest common subsequence");
    ...
    const wireCard = () => {
      ...
      target.dataset.longestCommonSubsequenceCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open Longest Common Subsequence practice page");
