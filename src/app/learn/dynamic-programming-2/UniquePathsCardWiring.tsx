...
export default function UniquePathsCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/dynamic-programming-2/unique-paths";
    ...
    const isCorrectCardText = (text: string) => {
      ...
      return (
        ...
        clean.includes("grid dp") &&
        clean.includes("rows and columns") &&
    ...
    const findCard = () => {
      ...
      ).filter((node) => normalize(node.textContent || "") === "unique paths");
    ...
    const wireCard = () => {
      ...
      target.dataset.uniquePathsCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open Unique Paths practice page");
