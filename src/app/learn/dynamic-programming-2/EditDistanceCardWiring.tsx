...
export default function EditDistanceCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/dynamic-programming-2/edit-distance";
    ...
    const isCorrectCardText = (text: string) => {
      ...
      return (
        ...
        clean.includes("canonical string-to-string dp table") &&
    ...
    const findCard = () => {
      ...
      ).filter((node) => normalize(node.textContent || "") === "edit distance");
    ...
    const wireCard = () => {
      ...
      target.dataset.editDistanceCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open Edit Distance practice page");
