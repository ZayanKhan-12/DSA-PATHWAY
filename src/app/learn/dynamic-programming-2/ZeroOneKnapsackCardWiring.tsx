...
export default function ZeroOneKnapsackCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/dynamic-programming-2/zero-one-knapsack";
    ...
    const isCorrectCardText = (text: string) => {
      ...
      return (
        ...
        clean.includes("capacity and item-index") &&
        clean.includes("state transitions") &&
    ...
    const findCard = () => {
      ...
      ).filter((node) => normalize(node.textContent || "") === "0/1 knapsack");
    ...
    const wireCard = () => {
      ...
      target.dataset.zeroOneKnapsackCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open 0/1 Knapsack practice page");
