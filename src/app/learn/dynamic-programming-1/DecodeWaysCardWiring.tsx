...
export default function DecodeWaysCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/dynamic-programming-1/decode-ways";
    ...
    const isCorrectCardText = (text: string) => {
      ...
      return (
        ...
        clean.includes("count possibilities") &&
        clean.includes("prefix-based recurrence") &&
    ...
    const findCard = () => {
      ...
      ).filter((node) => normalize(node.textContent || "") === "decode ways");
    ...
    const wireCard = () => {
      ...
      target.dataset.decodeWaysCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open Decode Ways practice page");
