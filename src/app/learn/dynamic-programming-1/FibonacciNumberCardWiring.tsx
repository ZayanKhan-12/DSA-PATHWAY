...
export default function FibonacciNumberCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/dynamic-programming-1/fibonacci-number";
    ...
    const isCorrectCardText = (text: string) => {
      ...
      return (
        ...
        clean.includes("simplest repeated-subproblem dp") &&
    ...
    const findCard = () => {
      ...
      ).filter((node) => normalize(node.textContent || "") === "fibonacci number");
    ...
    const wireCard = () => {
      ...
      target.dataset.fibonacciNumberCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open Fibonacci Number practice page");
