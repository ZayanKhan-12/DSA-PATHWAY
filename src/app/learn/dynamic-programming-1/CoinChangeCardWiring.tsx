...
export default function CoinChangeCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/dynamic-programming-1/coin-change";
    ...
    const isCorrectCardText = (text: string) => {
      ...
      return (
        ...
        clean.includes("optimize using smaller amounts first") &&
    ...
    const findCard = () => {
      ...
      ).filter((node) => normalize(node.textContent || "") === "coin change");
    ...
    const wireCard = () => {
      ...
      target.dataset.coinChangeCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open Coin Change practice page");
