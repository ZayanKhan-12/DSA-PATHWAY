...
export default function HouseRobberCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/dynamic-programming-1/house-robber";
    ...
    const isCorrectCardText = (text: string) => {
      ...
      return (
        ...
        clean.includes("classic 1d dp recurrence") &&
    ...
    const findCard = () => {
      ...
      ).filter((node) => normalize(node.textContent || "") === "house robber");
    ...
    const wireCard = () => {
      ...
      target.dataset.houseRobberCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open House Robber practice page");
