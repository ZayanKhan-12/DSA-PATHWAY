...
export default function BFSNumberOfIslandsCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/bfs/number-of-islands";
      ...
      for (const titleNode of titleNodes) {
        ...
        for (let depth = 0; depth < 6 && current; depth++) {
          ...
          const isExactCard =
            ...
            text.includes("Grid BFS") &&
            text.includes("flood fill") &&
    ...
    const wireCard = () => {
      ...
      if (target.dataset.bfsNumberOfIslandsCardWired === "true") return true;

      target.dataset.bfsNumberOfIslandsCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open BFS Number of Islands practice page");
