...
export default function MaximumNonOverlappingIntervalsCardWiring() {
  useEffect(() => {
    const internalRoute = "/practice/greedy-intervals/maximum-number-of-non-overlapping-intervals";
    ...
    const findCard = () => {
      ...
      ).filter((node) => normalize(node.textContent || "") === "maximum number of non-overlapping intervals");
    ...
    const wireCard = () => {
      ...
      target.dataset.maximumNonOverlappingIntervalsCardWired = "true";
      target.style.cursor = "pointer";
      target.setAttribute("role", "link");
      target.setAttribute("tabindex", "0");
      target.setAttribute("aria-label", "Open Maximum Number of Non-Overlapping Intervals practice page");
