...
const TOPICS: Topic[] = [
  { id: "01", code: "ARR", title: "Arrays & Hashing", difficulty: "EASY", problems: 24, status: "READY", desc: "Two pointers, prefix sums, frequency maps" },
  ...
  { id: "06", code: "GRH", title: "Graph Traversal", difficulty: "MED", problems: 28, status: "READY", desc: "BFS, DFS, topological sort, union-find" },
